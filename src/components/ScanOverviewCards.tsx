...
const ScanOverviewCards = ({ scans }: ScanOverviewCardsProps) => {
  ...
  return (
    <div className="grid grid-cols-[repeat(auto-fit,minmax(min(100%,13rem),1fr))] items-start gap-4 sm:gap-6">
      <SurfaceCard color="blue">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
          ...
          <div className="shrink-0 p-3 bg-blue-500/20 rounded-xl group-hover:scale-110 transition-transform duration-300">
      ...
      <SurfaceCard color="emerald">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
          ...
          <div className="shrink-0 p-3 bg-emerald-500/20 rounded-xl group-hover:scale-110 transition-transform duration-300">
      ...
      <SurfaceCard color="amber">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
          ...
          <div className="shrink-0 p-3 bg-amber-500/20 rounded-xl group-hover:scale-110 transition-transform duration-300">
      ...
      <SurfaceCard color="rose">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
          ...
          <div className="shrink-0 p-3 bg-rose-500/20 rounded-xl group-hover:scale-110 transition-transform duration-300">
      ...
      <SurfaceCard color="orange">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
          <CardTitle className="min-w-0 text-sm font-medium text-slate-600 dark:text-slate-300">Stopped Scans</CardTitle>
          <div className="shrink-0 p-3 bg-orange-500/20 rounded-xl group-hover:scale-110 transition-transform duration-300">
