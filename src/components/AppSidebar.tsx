...
import { Home, Scan, Settings, Activity, Sun, Moon, History, LogIn, LogOut, User, Loader2, CircleUser, Spider } from 'lucide-react'; // Changed Shield to Spider
      ...
      <SidebarHeader className="border-b border-border bg-sidebar-accent">
        <div className="flex items-center gap-3 px-4 py-4">
          <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-gradient-to-br from-blue-500 to-cyan-600 shadow-lg">
            <Spider className="text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]" size={28} /> {/* Changed icon and added drop shadow */}
          </div>
          <div>
